...
public class DialogueSystem2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (textLabel == null || nameLabel == null || faceImage == null || dialoguePanel == null || yesButton == null)
        {
    ...
    private void DisplayDialogue()
    {
        ...
        if (splitLine.Length == 2)
        {
            ...
            displayCoroutine = StartCoroutine(SetTextUI(dialogue));// ダイアログを一文字ずつ表示するコルーチンを開始
        }
        else
        {
    ...
    private void GetTextFromFile(TextAsset file)
    {
        ...
        if (file == null)
        {
            Debug.LogError("テキストファイルがインスペクターで割り当てられていません");
            return;
        }
